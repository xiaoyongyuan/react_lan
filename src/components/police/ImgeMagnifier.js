...
class ImageMagnifier extends Component {
    ...
    calculationBlock(offsetX, offsetY) {
        ...
        if (offsetX > this.props.widthEnlarge-50) {
            offsetX = this.props.widthEnlarge-50;
        }
        if (offsetY < 50) {
            offsetY = 50;
        }
        if (offsetY > this.props.heightNarrow-50) {
            offsetY = this.props.heightNarrow-50;
        }
    ...
    initParam() {
        ...
        cssStyle.magnifierContainer.width = this.props.widthEnlarge+ "px";
