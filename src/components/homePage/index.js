        ...
        <div className="alarmImg">
          <div className="alarmVideo">
            ...
            <div className="alarmVideoBottom">
              <span className="alarmVideoCircle" />
              <span className="alarmVideoName">新机房2号门</span>
            </div>
          </div>
          <div className="alarmVideo">
            <img src={defenceImg} alt="" />
    ...
    return (
      <div className="homePage">
        <div className="equNum">
          <div className="equ equ-right">
            ...
            <div className="equContext">
              ...
              <span className="equipTotal">
                <span className="equBer">
                  {this.state.cameraTotals ? this.state.cameraTotals : 0}
                </span>
                部
              </span>
            </div>
          ...
          <div className="equ equBorder">
            ...
            <div className="equContext">
              ...
              <span className="equipTotal">
                <span className="equBer">
                  {this.state.onlineCameras ? this.state.onlineCameras : 0}
                </span>
                部
              </span>
            </div>
          ...
          <div className="equ equBorder">
            ...
            <div className="equContext">
              ...
              <span className="equipTotal">
                <span className="equBer">
                  {this.state.downCameras ? this.state.downCameras : 0}
                </span>
                部
              </span>
            </div>
          ...
          <div className="equ equBorder">
            ...
            <div className="equContext">
              ...
              <span className="equipTotal-Handle">
                <span className="equBer">
                  {this.state.hasDealCount ? this.state.hasDealCount : 0}
                </span>
                条
              </span>
            </div>
          ...
          <div className="equ equBorder">
            ...
            <div className="equContext">
              ...
              <span className="equipTotal-UHandle">
                <span className="equBer">
                  {this.state.unDealCount ? this.state.unDealCount : 0}
                </span>
                条
              </span>
            </div>
          ...
          <div className="equ1 equ-left">
            ...
            <div className="equContext">
              ...
              <span className="equipTotal-today">
                <span className="equBer">
        ...
        <div className="computerRoom">
          <div className="computerRoom-context">
            ...
            <div className="computerRoomStatus">
              <div className="RoomStatusLeft">
                <p className="roomAlarm">
                  <span className="statusImg1" />
                  <span className="status1">有报警状态</span>
                </p>
                <p className="roomAlarm">
                  <span className="statusImg2" />
                  <span className="status2">无报警状态</span>
                </p>
                <p className="roomAlarm">
                  <span className="statusImg3" />
                  <span className="status3">离线</span>
                </p>
              </div>
          ...
          <div className="computerRoom-camera">
            <div className="video-camera">
              <span className="videoCameraName">
                <span className="videoImg" />
                <span className="videoName">机房智能摄像机</span>
              </span>
              <Icon type="close" onClick={this.hanleClose} className="close" />
            </div>
            <div className="eqiIp">
            ...
            <div className="fortification">
              <div className="fortification-title">
                <span className="videoImg" />
                <span className="videoName">设防情况</span>
              </div>
              <div className="defended">
                <div
                  className="defended-title"
                  onClick={() => this.hanleDefence("已布防")}
                >
                ...
                <div
                  className="defended-title"
                  onClick={() => this.hanleDefence("已撤防")}
                >
                  <span className={this.hanleBgColor1("已撤防")}>已撤防</span>
                  <span className={this.hanleBgColor2("已撤防")} />
                </div>
              </div>
              <button className={this.hanledefendedBtn()}>
                {this.state.fortification === "已布防"
                  ? "一键撤防"
                  : "一键布防"}
              </button>
            </div>
            <div className="lastAlarm">
              <div className="alarm-title">
                <span className="videoImg" />
                <span className="videoName">最新一次报警情况</span>
              </div>
              {this.hanlelastAlarm()}
            </div>
          </div>
        ...
        <div className="alarminfor">
          <a href="#/main/policeInformation">
            <div className="alarminfornikName">
              <span className="alarminfornikName-title">更多报警信息</span>
              ...
              {this.state.policeList.map((v, i) => (
                <Col className="gutter-row" span={4} key={i}>
                  <div
                    ...
                    onClick={() => this.hanleWithdrawal(v.code)}
                  >
                    <img
                      src={v.picpath ? v.picpath : defenceImg}
                      alt=""
                      className="defence"
                    />
                    ...
                    <div className={this.hanlePoliceBg(v.status)}>
                      ...
                      <span className="policeStatusFont">
                        {this.hanleStatus(v.status)}
                      </span>
                    </div>
        ...
        <div className="nodata">
          <img
            ...
            style={{
              width: "80px",
              height: "78px",
              display: this.state.policeList.length > 0 ? "none" : "block"
            }}
          />
        </div>
        <Modal
